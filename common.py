...
FINAL_ANSWER_PATTERN = r"(?i)Final Answer\s*:\s*([^\n]+)"
...
def map_without_progress(f: callable, xs: list, num_threads: int = 50):
    """
    Apply f to each element of xs, using a ThreadPool.
    """
    if os.getenv("debug"):
